#!/usr/bin/env python3
"""Test AI extraction with triple-click selection"""
...
print("Testing AI text extraction with triple-click...")
...
# Triple-click in AI response area to select all
print("5. Triple-clicking AI response area at (1002, 821) to select all...")
click(1002, 821)
time.sleep(0.2)
click(1002, 821)
time.sleep(0.2)
